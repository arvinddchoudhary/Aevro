      ...
      <section className="border-t border-[#ddd4c8] bg-[#f3eadf]/55">
        ...
        <div>
          ...
          <div className="mt-6 flex gap-4">
            <a href="https://instagram.com/theaevro" target="_blank" rel="noopener noreferrer" aria-label="AEVRO on Instagram" className="text-[#514c45] transition-colors hover:text-[#111111]">
